...
export default class CitationConverter extends MarkupConverter {
    ...
    getHTMLElement = (JIRAMarkup) => {
        this.validateJIRAMarkup(JIRAMarkup, "Invalid JIRA markup, expected text between double ??question?? marks");
