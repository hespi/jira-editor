...
export default class JiraEditor extends React.Component {
  static propTypes = {
  ...
  set text(value) {
    this.setState({
      editorState: value
        ? this._convertTextToEditorState(value)
  ...
  set html(value) {
    this.setState({
      editorState: value
        ? this._convertHtmlToEditorState(value)
        : EditorState.createEmpty()
    })
  }
  ...
  constructor(props) {
    ...
    this.state = {
      editorState: props.html
        ? this._convertHtmlToEditorState(props.html)
        : props.text
        ? this._convertTextToEditorState()
        : EditorState.createEmpty()
    }
  }
  ...
  render() {
    ...
    return (
      <div className='jira-editor-wrapper'>
        ...
        />
        {!!this.props.required && (
          <input type='text' required defaultValue={this.text} />
        )}
      </div>
    )
  }
