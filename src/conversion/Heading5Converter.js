...
export default class Heading5Converter extends MarkupConverter {
    ...
    getHTMLElement = (JIRAMarkup) => {
        this.validateJIRAMarkup(JIRAMarkup, "Invalid JIRA markup, expected text starting with 'h5. '");
    ...
    _doGetJIRAMarkup = (HTMLElement) => {
        return `h5. ${HTMLElement.innerHTML}`;
    }
