...
export default class Heading2Converter extends MarkupConverter {
    ...
    getHTMLElement = (JIRAMarkup) => {
        this.validateJIRAMarkup(JIRAMarkup, "Invalid JIRA markup, expected text starting with 'h2. '");
    ...
    _doGetJIRAMarkup = (HTMLElement) => {
        return `h2. ${HTMLElement.innerHTML}`;
    }
